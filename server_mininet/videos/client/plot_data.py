...
data = pd.read_csv('./server_mininet/videos/client/data.csv')
data['Time'] = data['Time'].apply(convert_to_seconds)

resolution_data = pd.read_csv('./server_mininet/videos/client/resolutionData.csv')
resolution_data['Time'] = resolution_data['Time'].apply(convert_to_seconds)

droppedFrames_data = pd.read_csv('./server_mininet/videos/client/droppedFrames.csv')
